...
Heuristics (additive score):
    1. injection_patterns   +0.4  — "ignore previous", "disregard above", LLaMA tokens, etc.
    ...
    8. code_injection       +0.4  — <script>, javascript:, eval(), __import__, exec(), os.system, etc.
    9. persona_override     +0.3  — imperative identity/behavior override phrases
...
def assess_poisoning(text: str) -> PoisonAssessment:
    ...
    # --- Heuristic 1: Injection pattern (+0.4, counted once) ---
